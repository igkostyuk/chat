...
const MAX_USER_NAME_SIZE: usize = 255;
...
impl TryFrom<String> for UserName {
    ...
    fn try_from(s: String) -> Result<Self, Self::Error> {
        ...
        let is_too_long = s.graphemes(true).count() > MAX_USER_NAME_SIZE;
